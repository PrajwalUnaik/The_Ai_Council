...
def _save_partial_results(
    ...
    if agreement:
        partial_metadata["agreement"] = agreement
...
async def _run_council_pipeline(
    ...
    *,
    ...
    if execution_mode in ("chat_ranking", "full"):
        ...
        result.agreement = compute_agreement(result.stage2, result.label_to_model) if result.stage2 else None
    ...
    async def event_generator():
        ...
        try:
            ...
            if body.execution_mode in ["chat_ranking", "full"]:
                ...
                agreement = compute_agreement(stage2_results, label_to_model)
                yield f"data: {json.dumps({'type': 'stage2_complete', 'data': stage2_results, 'metadata': {'label_to_model': label_to_model, 'aggregate_rankings': aggregate_rankings, 'agreement': agreement, 'search_query': search_query, 'search_context': search_context}})}\n\n"
                await asyncio.sleep(0.05)
    ...
    async def event_generator():
        ...
        try:
            ...
            async for event in run_iterative_debate(
                ...
                if event_type == "debate_complete":
                    ...
                    if rounds_data:
                        ...
                        final_agreement = last_meta.get("agreement")
            ...
            if body.execution_mode in ["chat_ranking", "full"]:
                ...
                metadata["agreement"] = final_agreement
