...
export default function SearchableModelSelect({
  ...
  const customStyles = useMemo(() => ({
    control: (base, state) => ({
      ...base,
      backgroundColor: 'rgba(30, 26, 51, 0.8)',
      borderColor: state.isFocused ? '#8b7cf6' : 'rgba(158, 151, 199, 0.2)',
      borderRadius: '8px',
      minHeight: '38px',
      boxShadow: state.isFocused ? '0 0 0 2px rgba(139, 124, 246, 0.3)' : 'none',
      '&:hover': {
        borderColor: '#8b7cf6',
      },
    }),
    menu: (base) => ({
      ...base,
      backgroundColor: 'rgba(30, 26, 51, 0.98)',
      borderRadius: '8px',
      border: '1px solid rgba(158, 151, 199, 0.2)',
    ...
    option: (base, state) => ({
      ...
      backgroundColor: state.isSelected
        ...
        : state.isFocused
          ...
          : 'transparent',
      color: state.isSelected ? '#ffffff' : '#e6e2f5',
      padding: '8px 12px',
      borderRadius: '4px',
      cursor: 'pointer',
      fontSize: '13px',
