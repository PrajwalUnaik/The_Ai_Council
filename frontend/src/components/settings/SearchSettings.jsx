                    ...
                    <div key={provider.id} className={`provider-option-container ${selectedSearchProvider === provider.id ? 'selected' : ''}`}>
                        ...
                        {selectedSearchProvider === 'serper' && provider.id === 'serper' && (
                            <div className="inline-api-key-section">
                                ...
                                <a 
                                    ...
                                    style={{ marginTop: '8px', display: 'inline-block', fontSize: '12px', color: '#a89bfa' }}
                                >
                        ...
                        {selectedSearchProvider === 'tinyfish' && provider.id === 'tinyfish' && (
                            <div className="inline-api-key-section">
                                ...
                                <div className="rate-limit-notice" style={{ marginTop: '8px', fontSize: '12px', color: '#9e97c7' }}>
                                    ⚠ Free tier: 5 searches/min. Upgrade at <a href="https://agent.tinyfish.ai" target="_blank" rel="noopener noreferrer" style={{ color: '#a89bfa' }}>agent.tinyfish.ai</a> for higher limits.
                                </div>
                                <a
