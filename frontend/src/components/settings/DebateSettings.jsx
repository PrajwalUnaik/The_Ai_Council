    ...
    const getMeterInfo = (rounds) => {
        if (rounds === 1) {
            ...
            return {
                ...
                color: '#f0b429', // Amber alert color
        ...
        <section className="debate-settings-section">
            <div className="debate-section-header">
                <div className="debate-title-wrapper">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1ba8e8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="debate-title-icon">
                        <path d="M17 6.1H3" />
                        <path d="M21 12H3" />
                        <path d="M17 17.9H3" />
                    </svg>
